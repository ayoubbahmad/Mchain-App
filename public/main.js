...
module.exports = "<app-navbar></app-navbar><br><br><br><br>\n<div class=\"container\">\n  <flash-messages></flash-messages>\n  <router-outlet></router-outlet>\n</div>\n\n\n<!-- Footer -->\n<footer class=\"page-footer font-small special-color-dark pt-4\">\n    <!-- Copyright -->\n    <div class=\"footer-copyright text-center py-3\">© 2018 Copyright:\n      <a href=\"#\">Ayoub Bahmad</a>\n    </div>\n  <!-- Copyright -->\n</footer>\n"
...
/* harmony import */ var _guards_unauth_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./guards/unauth.guard */ "./src/app/guards/unauth.guard.ts");
...
var appRoutes = [
    ...
    { path: 'register', component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"], canActivate: [_guards_unauth_guard__WEBPACK_IMPORTED_MODULE_14__["UnAuthGuard"]] },
    { path: 'login', component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], canActivate: [_guards_unauth_guard__WEBPACK_IMPORTED_MODULE_14__["UnAuthGuard"]] },
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_8__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_9__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"]] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_11__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_12__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"], _guards_unauth_guard__WEBPACK_IMPORTED_MODULE_14__["UnAuthGuard"]],
...
module.exports = "\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col\">\n      <div class=\"jumbotron\">\n      <h1>Sign a file</h1>\n\n          <div class=\"custom-file\">\n            <input class=\"custom-file-input\" id=\"inputGroupFile02\" type=\"file\" name=\"FileToSign\" (change)='onFileChange($event)' >\n            <label class=\"custom-file-label\" for=\"inputGroupFile02\">{{Choose_file_to_sign}}</label>\n          </div><br><br>\n\n        <button type=\"button\" class=\"btn btn-success btn-s\"\n           (click)='signFile()' [disabled]=\"!FILE_TO_SIGNE_CHOOSED\">\n              sign File\n        </button>\n      <br>\n        <hr class=\"my-4\">\n      <br>\n\n        <div class=\"\">\n          <h1 class=\"display-3\" ></h1>\n        </div>\n\n        <div class=\"card border-info mb-3\" *ngIf=\"signature\">\n          <div class=\"card-header\">signature</div>\n          <div class=\"card-body\">\n            <p class=\"card-text\">{{signature}}</p>\n          </div>\n        </div>\n      </div>\n\n    </div>\n    <div class=\"col\">\n\n\n      <div class=\"jumbotron\">\n        <div class=\"alert alert-dismissible alert-danger\" *ngIf='VALID_SIGNATUR == false'>\n          <strong>Non valide File</strong>\n        </div>\n        <div class=\"alert alert-dismissible alert-success\" *ngIf='VALID_SIGNATUR == true'>\n          <strong>Valide File</strong>\n        </div>\n      <h1>Verify a file</h1>\n      <div class=\"custom-file\">\n        <input class=\"custom-file-input\" id=\"inputGroupFile02\" type=\"file\" name=\"FileToVerify\" (change)='onFileChange($event)' >\n        <label class=\"custom-file-label\" for=\"inputGroupFile02\">{{Choose_file_to_verify}}</label>\n      </div><br><br>\n\n        <button type=\"button\" class=\"btn btn-success btn-s\"\n           (click)='veifyFile()' [disabled]=\"!FILE_TO_VERIFY_CHOOSED\">\n              Verify File\n        </button>\n      <br>\n        <hr class=\"my-4\">\n      <br>\n\n        <div class=\"\">\n          <h1 class=\"display-3\" ></h1>\n        </div>\n\n          <div class=\"card border-info mb-3\" >\n            <div class=\"card-header\">Signature</div>\n            <div class=\"card-body\">\n              <textarea class=\"form-control\" id=\"signatureToVerify\" [(ngModel)]=\"signatureToVerify\" name=\"signatureToVerify\"></textarea>\n            </div>\n          </div>\n      </div>\n\n    </div>\n  </div>\n</div>\n"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.signFile = function () {
        var _this = this;
        var fd = new FormData();
        fd.append('file', this.selectedFile, this.selectedFile.name);
        fd.append('data', 'ayoubbahmad');
        this.http.post('http://localhost:3000/api/sign', fd).subscribe(function (res) {
            if (res.success) {
    ...
    DashboardComponent.prototype.veifyFile = function () {
        var _this = this;
        var fd = new FormData();
        fd.append('file', this.selectedFile, this.selectedFile.name);
        fd.append('signature', this.signatureToVerify);
        this.http.post('http://localhost:3000/api/verify', fd).subscribe(function (res) {
            if (res.success) {
                _this.VALID_SIGNATUR = res.verification;
            }
            //console.log(res);
        });
    };
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Welcome <3', { cssClass: 'alert-success', timeout: 5000 });
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessage.show('Well loggedOut', { cssClass: 'alert-success', timeout: 5000 });
...
module.exports = "<h2>HEllo Profile</h2>\n\n <div *ngIf=\"user\">\n  <h2 class=\"page-header\">{{user.name}}</h2>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">Username : {{user.username}}</li>\n    <li class=\"list-group-item\">Email : {{user.email}}</li>\n    <li class=\"list-group-item\">Address : {{user.bitAddress}}</li>\n  </ul>\n</div>\n"
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<form (submit)=\"onRegisterSubmit(f)\">\n  <div class=\"form-group\">\n    <label>Name</label>\n        <input  type=\"text\" name=\"name\" class=\"form-control\" placeholder=\"Enter name\" [(ngModel)]=\"name\">\n  </div>  \n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" placeholder=\"Enter username\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Email</label>\n    <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" placeholder=\"Enter email\" class=\"form-control\" >\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" [(ngModel)]=\"password\" placeholder=\"Enter password\" name=\"password\" class=\"form-control\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n</form>\n"
...
module.exports = __webpack_require__(/*! C:\Users\stefany\Desktop\MchainApp - Dashboard last test - Copy\angular-src\src\main.ts */"./src/main.ts");
